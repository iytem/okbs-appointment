<?= breadcrumbs("Uygulama İzinleri","fa-check",array("Uygulama İzinleri","Liste"))?>
            ...
            <div class="box box-solid">
                <div class="box-header with-border">
                    <h1 class="box-title" style="color: tomato"><i
                                class="fa fa-list-alt"></i> İzin Listesi</h1>

                        <a class="btn btn-flat btn-bitbucket btn_add_new btn-sm pull-right" id="btn_add_new"
                           data-toggle="tooltip" data-placement="top" title="Yeni Yetki"
                           href="javascript:void(0)" onclick="generate_modal('add','','Yetki Ekleme')"><i
                                    class="fa fa-plus-square-o"></i> İzin Ekle</a>
...
<script>
    ...
    $(document).ready(function () {
        table = $('#table').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": BASE_URL + "cms/permission/grid_view",
                "type": "POST",
                "data": function (data) {
    ...
    function generate_modal(par, id, title) {
        $.ajax({
            type: 'POST',
            url: BASE_URL + 'cms/permission/modal_render',
            data: {
                'param': par, 'value': id,
