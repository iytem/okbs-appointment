...
<?= form_open(base_url('ziyaretci/add_save/'), [
    'name' => 'form_ziyaretci',
...
<div class="form-group ">
    <div class="col-sm-12">
        <input type="text" class="form-control" name="ziyaretci_ad_soyad" id="ziyaretci_ad_soyad" placeholder="Ad ve Soyad"
               value="<?= set_value('ziyaretci_ad_soyad'); ?>">
    </div>
</div>
...
<div class="form-group ">
    ...
    <div class="col-sm-12">
        <input type="text" class="form-control" name="ziyaretci_referans" id="ziyaretci_referans" placeholder="Referans"
               value="<?= set_value('ziyaretci_referans'); ?>">
    </div>
</div>
...
<?php else: ?>
    <input type="hidden" class="form-control" name="ziyaretci_birim" id="ziyaretci_birim" placeholder="Birim"
           value="<?= set_value('ziyaretci_birim', $this->aauth->get_user()->user_birim); ?>">
<?php endif; ?>
...
<div class="form-group ">
    ...
    <div class="col-sm-12">
        <textarea name="ziyaretci_not" id="ziyaretci_not" cols="30" rows="5" class="form-control"></textarea>
