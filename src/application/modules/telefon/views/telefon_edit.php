...
<?= form_open(base_url('telefon/edit_save/'.$telefon->telefon_id), [
    'name' => 'form_telefon',
...
<div class="form-group ">
    <div class="col-sm-6 col-xs-6">
        <input type="text" class="form-control" name="telefon_ad_soyad" id="telefon_ad_soyad" placeholder="Ad ve Soyad"
               value="<?= set_value('telefon_ad_soyad',$telefon->telefon_ad_soyad); ?>">
    </div>
    <div class="col-sm-6 col-xs-6">
        <input type="text" class="form-control" name="telefon_calistigi_yer" id="telefon_calistigi_yer" placeholder="Çalıştığı Kurum"
               value="<?= set_value('telefon_calistigi_yer',$telefon->telefon_calistigi_yer); ?>">
    </div>
</div>
<div class="form-group ">
    ...
    <div class="col-sm-12">
        <input type="text" class="form-control" name="telefon_sebep" id="telefon_sebep" placeholder="Arama Sebebi"
               value="<?= set_value('telefon_sebep',$telefon->telefon_sebep); ?>">
    </div>
</div>
...
<div class="form-group ">
    ...
    <div class="col-sm-12">
        <input type="text" class="form-control" name="telefon_no" id="telefon_no" placeholder="Telefon No"
               value="<?= set_value('telefon_no',$telefon->telefon_no); ?>">
    </div>
</div>
...
<div class="form-group ">
    <div class="col-sm-6 col-xs-6">
        <input type="text" class="form-control dateInput" name="telefon_tarih" id="telefon_tarih" placeholder="Tarih"
               value="<?= set_value('telefon_tarih',$telefon->telefon_tarih); ?>">
    </div>
    <div class="col-sm-6 col-xs-6">
        <input type="text" class="form-control" name="telefon_saat" id="telefon_saat" placeholder="Saat"
               value="<?= set_value('telefon_saat',$telefon->telefon_saat); ?>">
    </div>
</div>
<div class="form-group ">
    ...
    <div class="col-sm-12">
        <select class="form-control chosen" name="telefon_durum" id="telefon_durum"
                placeholder="Seçiniz">
            <option value=""></option>
            <option value="2" <?= $telefon->telefon_durum==1 ? "selected":""?>>Geri Dönüş Bekleyen Listesine At</option>
            <option value="3" <?= $telefon->telefon_durum==3 ? "selected":""?>>Geri Dönüş Yapıldı</option>
            <option value="4" <?= $telefon->telefon_durum==4 ? "selected":""?>>Geri Dönüş Yapılmadı</option>
        </select>
    </div>
</div>
        ...
        <div class="col-sm-12">
            <select class="form-control chosen " name="telefon_birim" id="telefon_birim"
                ...
                <?php foreach (db_get_all_data('okbs_birim', ['birim_durum' => 1]) as $row): ?>
                    <option value="<?= $row->birim_id; ?>" <?= $telefon->telefon_birim==$row->birim_id?"selected":""?>><?= ucwords($row->birim_adi); ?></option>
                <?php endforeach; ?>
            </select>
        </div>
    </div>
<?php else: ?>
    <input type="hidden" class="form-control" name="telefon_birim" id="telefon_birim" placeholder="Birim"
           value="<?= set_value('telefon_birim', $telefon->telefon_birim); ?>">
<?php endif; ?>
...
<div class="form-group ">
    ...
    <div class="col-sm-12">
        <textarea name="telefon_notlar" id="telefon_notlar" cols="30" rows="5" class="form-control"><?=$telefon->telefon_notlar?></textarea>
