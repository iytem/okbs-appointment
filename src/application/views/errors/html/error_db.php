...
<head>
    ...
    <link rel="stylesheet" href="<?= cms_theme_assets_folder("dist/css/AdminLTE.min.css") ?>">
...
<script src="<?= cms_theme_assets_folder("plugins/jquery_/dist/jquery.min.js") ?>"></script>
