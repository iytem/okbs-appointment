...
$config['hosts'] = array('ldap2.iyte.edu.tr');
$config['ports'] = array(389);
$config['basedn'] = 'ou=iyteusers,dc=iyte,dc=edu,dc=tr';
$config['login_attribute'] = 'cn';
$config['proxy_user'] = ''; // 'cn=spclobsid@spcl.obsid,ou=spclusers,dc=iyte,dc=edu,dc=tr';
$config['proxy_pass'] = ''; // 'veryhardpassword';
$config['items'] = array('cn','tc-kimlik','givenname','sn','acct-aktif');
$config['member_attribute'] = 'cn';
$config['auditlog'] = 'application/logs/audit-ldap.log';
// Some place to log attempted logins (separate from message log)
//$config['userlists'] = array(
//                        'ahmetaksit@iyte.edu.tr',
//    );
?>
