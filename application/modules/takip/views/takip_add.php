...
<?= form_open(base_url('takip/add_save/'), [
    'name' => 'form_takip',
...
<div class="form-group ">
    <label for="email" class="col-sm-6 col-xs-6">Ad Soyad <i class="required">*</i></label>
    <label for="email" class="col-sm-6 col-xs-6">TC/Sicil No <i class="required">*</i></label>

</div>
<div class="form-group ">
    <div class="col-sm-6 col-xs-6">
        <input type="text" class="form-control" name="takip_ad_soyad" id="takip_ad_soyad" placeholder="Ad Soyad"
               value="<?= set_value('takip_ad_soyad'); ?>">
    </div>
    <div class="col-sm-6 col-xs-6">
        <input type="text" class="form-control" name="takip_sicil_tc" id="takip_sicil_tc" placeholder="TC/Sicil No"
               value="<?= set_value('takip_sicil_tc'); ?>">
    </div>
...
<div class="form-group ">
    ...
    <div class="col-sm-12">
        <input type="text" class="form-control" name="takip_iletisim_bilgileri" id="takip_iletisim_bilgileri"
               ...
               value="<?= set_value('takip_iletisim_bilgileri'); ?>">
    </div>
</div>
...
<div class="form-group ">
    ...
    <div class="col-sm-12">
        <input type="text" class="form-control" name="takip_konu" id="takip_konu" placeholder="Konu"
               value="<?= set_value('takip_konu'); ?>">
    </div>
</div>

<div class="form-group ">
    <label for="full_name" class="col-sm-6 col-xs-6">Geldiği Yer <i
                class="required">*</i></label>
    <label for="email" class="col-sm-6  col-xs-6">Geliş Tarihi <i class="required">*</i></label>

    <div class="col-sm-6  col-xs-6">
        <input type="text" class="form-control" name="takibin_geldigi_yer" id="takibin_geldigi_yer"
               placeholder="Geldiği Yer"
               value="<?= set_value('takibin_geldigi_yer'); ?>">
    </div>
    <div class="col-sm-6  col-xs-6">
        <input type="text" class="form-control dateInput" name="takip_gelis_tarihi" id="takip_gelis_tarihi"
               placeholder="Geliş Tarihi"
               value="<?= set_value('takip_gelis_tarihi'); ?>">
    </div>
</div>
...
<?php else: ?>
    <input type="hidden" class="form-control" name="takip_birim" id="takip_birim" placeholder="Birim"
           value="<?= set_value('takip_birim', $this->aauth->get_user()->user_birim); ?>">
<?php endif; ?>
...
<div class="form-group ">
    <label for="definition" class="col-sm-3">Notlar <i
                class="required">*</i></label>
    <div class="col-sm-12">
        <textarea name="takip_sonuc_notu" id="takip_sonuc_notu" cols="30" rows="3" class="form-control"></textarea>
